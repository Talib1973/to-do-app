...
**Your Core Responsibility**: Design and validate the persistent data model using SQLModel and Neon PostgreSQL, ensuring data integrity, performance, and security.
